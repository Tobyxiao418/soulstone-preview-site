...
const STONES = [
  ...
  {
    id: 'lapis-chunk',
    name: 'Lapis Lazuli Chunk',
    color: '#1F3E8A',
    gradient: 'radial-gradient(circle at 30% 24%, #5b78c8, #244a9b 36%, #112a62 76%, #071438 100%)',
    price: 7.0,
    size: 12,
    intention: ['Protection', 'Clarity'],
    description: 'Large rectangular blue stone cuts with natural gold-like flecks. A statement hero material for bolder custom pieces.',
    origin: 'Afghanistan',
    texture: 'chunk',
    type: 'stone',
    shape: 'rectangle',
  ...
  {
    id: 'prehnite-nugget',
    name: 'Prehnite Nugget',
    color: '#B8D7A8',
    gradient: 'radial-gradient(circle at 34% 26%, #eff8dc, #b8d7a8 34%, #7fa76e 72%, #4e6f44 100%)',
    price: 6.2,
    size: 11,
    intention: ['Abundance', 'Calm'],
    description: 'Pale green irregular nuggets with soft translucency. Adds organic shape and gentle growth energy.',
    origin: 'South Africa',
    texture: 'chunk',
    type: 'stone',
    shape: 'nugget',
  ...
  {
    id: 'clear-quartz-chunk',
    name: 'Clear Quartz Chunk',
    color: '#F5F4EF',
    gradient: 'radial-gradient(circle at 28% 24%, #ffffff, #f5f4ef 32%, #c8d0d8 66%, #8c98a8 100%)',
    price: 6.5,
    size: 12,
    intention: ['Clarity', 'Calm'],
    description: 'Large irregular clear quartz pieces with icy inclusions. The strongest visual signal for the new chunky atelier style.',
    origin: 'Brazil',
    texture: 'chunk',
    type: 'stone',
    shape: 'raw-cut',
  ...
  {
    id: 'baroque-pearl-large',
    name: 'Large Baroque Pearl',
    color: '#F5EBDD',
    gradient: 'radial-gradient(circle at 30% 22%, #fffdf4, #f5ebdd 34%, #d8c5aa 68%, #aa9279 100%)',
    price: 8.0,
    size: 10,
    intention: ['Love', 'Calm', 'Abundance'],
    description: 'Larger organic pearl with uneven nacre and sculptural shape. Adds gift-ready softness and luxury contrast.',
  ...
  {
    id: 'silver-charm-moon',
    name: 'Silver Moon Charm',
    color: '#D7D3C8',
    gradient: 'radial-gradient(circle at 30% 26%, #fffdf7, #d7d3c8 38%, #9e988e 72%, #5e5a54 100%)',
    price: 4.5,
    size: 5,
    intention: ['Love', 'Calm', 'Clarity'],
    description: 'Small sterling silver charm that gives a custom design a finished jewelry detail.',
    origin: 'Thailand',
    texture: 'polished',
    type: 'hardware',
    shape: 'charm',
  ...
  {
    id: 'silver-tube-spacer',
    name: 'Silver Tube Spacer',
    color: '#CFCBC2',
    gradient: 'linear-gradient(90deg, #777, #f6f2e9 28%, #b9b4aa 62%, #5e5a54)',
    price: 3.2,
    size: 5,
    intention: [],
    description: 'Small sterling silver tube spacer for a more designer, less bead-string look.',
    origin: 'Thailand',
    texture: 'polished',
    type: 'hardware',
    shape: 'tube',
  ...
  },
  {
    ...
    name: 'Navy Silk Cord',
    color: '#17264B',
    gradient: 'linear-gradient(135deg, #0a1024, #17264B 45%, #38528C)',
    price: 2.8,
    size: 3,
    intention: ['Protection', 'Clarity', 'Calm'],
    description: 'Adjustable navy cord option for wrap and knot styles. Gives the design a handmade DIY construction cue.',
    origin: 'Braided silk cord',
    texture: 'cord',
    type: 'cord',
    shape: 'cord',
    isAccent: true,
  },
  {
    ...
    name: 'Sand Silk Cord',
    color: '#B99E78',
    gradient: 'linear-gradient(135deg, #725b3e, #b99e78 48%, #ead6b8)',
    price: 2.8,
    size: 3,
    intention: ['Love', 'Abundance', 'Calm'],
    description: 'Warm neutral cord for softer bracelets and gift-ready pieces.',
    origin: 'Braided silk cord',
    texture: 'cord',
    type: 'cord',
    shape: 'cord',
...
const PRESETS = [
  {
    ...
    stones: ['clear-quartz-chunk', 'aquamarine', 'baroque-pearl-large', 'moonstone', 'silver-tube-spacer', 'aquamarine', 'navy-cord', 'freshwater-pearl', 'clear-quartz-chunk', 'silver-charm-moon', 'moonstone', 'baroque-pearl-large', 'aquamarine'],
  ...
  },
  {
    ...
    stones: ['clear-quartz-chunk', 'citrine', 'lemon-quartz', 'silver-tube-spacer', 'baroque-pearl-large', 'clear-quartz', 'sand-cord', 'citrine', 'clear-quartz-chunk', 'silver-charm-moon', 'lemon-quartz', 'baroque-pearl-large', 'citrine'],
  ...
  },
  {
    ...
    stones: ['baroque-pearl-large', 'rose-quartz', 'moonstone', 'freshwater-pearl', 'sand-cord', 'silver-charm-moon', 'rose-quartz', 'baroque-pearl-large', 'moonstone', 'silver-tube-spacer', 'rose-quartz', 'freshwater-pearl', 'baroque-pearl-large'],
  ...
  },
  {
    ...
    stones: ['lapis-chunk', 'smoky-quartz', 'obsidian', 'silver-tube-spacer', 'navy-cord', 'smoky-quartz', 'lapis-chunk', 'obsidian', 'silver-charm-moon', 'smoky-quartz', 'obsidian', 'silver-tube-spacer', 'lapis-chunk'],
  ...
  },
  {
    ...
    stones: ['prehnite-nugget', 'green-aventurine', 'citrine', 'baroque-pearl-large', 'sand-cord', 'silver-tube-spacer', 'prehnite-nugget', 'freshwater-pearl', 'citrine', 'silver-charm-moon', 'green-aventurine', 'baroque-pearl-large', 'prehnite-nugget'],
